...
?>
	...
	<div class="popup-content">
		...
		<div class="flex justify-center p-4 mb-8">
			<button class="store green" data-controler="Propriete">Enregistrer</button>
			<?php if(isset($propriete)) { ?>
				<button class="delete red" data-controler="Propriete" value="<?= $propriete["id"] ?>">Supprimer</button>
			<?php } ?>
			<button class="abort">Quitter</button>
		</ul>
	</div>
